...
#
# Project: Reference NIC (2cpu_lab6)
# Description: Reference NIC
#
#############################################################

package reg_defines_2cpu_lab6;
...
@EXPORT = qw(
                ...
                PIPELINE_DATAPATH_HWREG1_REG
                PIPELINE_DATAPATH_ADDREG_IMEM_INTERACT_REG
                PIPELINE_DATAPATH_ADDREG_IMEM_RW_ADDRESS_REG
                PIPELINE_DATAPATH_ADDREG_IMEM_WDATA_REG
                PIPELINE_DATAPATH_ADDREG_IMEM_WRITE_REG
...
# File: projects/2cpu_lab6/include/pipeline_datapath.xml
...
sub PIPELINE_DATAPATH_IMEM_RDATA_REG ()               { 0x2001210;}
sub PIPELINE_DATAPATH_HWREG1_REG ()                   { 0x2001214;}
sub PIPELINE_DATAPATH_ADDREG_IMEM_INTERACT_REG ()     { 0x2001218;}
sub PIPELINE_DATAPATH_ADDREG_IMEM_RW_ADDRESS_REG ()   { 0x200121c;}
sub PIPELINE_DATAPATH_ADDREG_IMEM_WDATA_REG ()        { 0x2001220;}
sub PIPELINE_DATAPATH_ADDREG_IMEM_WRITE_REG ()        { 0x2001224;}
