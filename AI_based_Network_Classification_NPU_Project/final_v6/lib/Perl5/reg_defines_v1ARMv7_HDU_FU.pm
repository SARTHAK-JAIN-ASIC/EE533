...
#
# Project: ARM CPU (v1ARMv7_HDU_FU)
# Description: ARM CPU
#
#############################################################

package reg_defines_v1ARMv7_HDU_FU;
...
sub DEVICE_PROJ_DIR ()  { "v1ARMv7_HDU_FU"; }
...
# File: projects/v1ARMv7_HDU_FU/include/arm_datapath.xml
