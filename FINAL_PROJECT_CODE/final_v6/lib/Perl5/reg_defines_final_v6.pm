...
#
# Project: ARM CPU (final_v6)
# Description: ARM CPU
#
#############################################################

package reg_defines_final_v6;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                ILA_TOP_ILA_UPPER_0_REG
                ILA_TOP_ILA_LOWER_0_REG
                ILA_TOP_ILA_UPPER_1_REG
                ILA_TOP_ILA_LOWER_1_REG
                ILA_TOP_ILA_UPPER_2_REG
                ILA_TOP_ILA_LOWER_2_REG
                ILA_TOP_ILA_UPPER_3_REG
                ILA_TOP_ILA_LOWER_3_REG
                ILA_TOP_ILA_UPPER_4_REG
                ILA_TOP_ILA_LOWER_4_REG
                ILA_TOP_ILA_UPPER_5_REG
                ILA_TOP_ILA_LOWER_5_REG
                ILA_TOP_ILA_UPPER_6_REG
                ILA_TOP_ILA_LOWER_6_REG
                ILA_TOP_ILA_UPPER_7_REG
                ILA_TOP_ILA_LOWER_7_REG
                ILA_TOP_ILA_UPPER_8_REG
                ILA_TOP_ILA_LOWER_8_REG
                ILA_TOP_ILA_UPPER_9_REG
                ILA_TOP_ILA_LOWER_9_REG
                ILA_TOP_ILA_UPPER_10_REG
                ILA_TOP_ILA_LOWER_10_REG
                ILA_TOP_ILA_UPPER_11_REG
                ILA_TOP_ILA_LOWER_11_REG
                ILA_TOP_ILA_UPPER_12_REG
                ILA_TOP_ILA_LOWER_12_REG
                ILA_TOP_ILA_UPPER_13_REG
                ILA_TOP_ILA_LOWER_13_REG
                ILA_TOP_ILA_UPPER_14_REG
                ILA_TOP_ILA_LOWER_14_REG
                ILA_TOP_ILA_UPPER_15_REG
                ILA_TOP_ILA_LOWER_15_REG
                ARM_DATAPATH_IMEM_INTERACT_REG
                ARM_DATAPATH_IMEM_WRITE_REG
                ARM_DATAPATH_IMEM_RW_ADDRESS_REG
                ARM_DATAPATH_IMEM_WDATA_REG
                ARM_DATAPATH_DMEM_INTERACT_REG
                ARM_DATAPATH_DMEM_WRITE_REG
                ARM_DATAPATH_DMEM_RW_ADDRESS_REG
                ARM_DATAPATH_DMEM_WDATA_UPPER_REG
                ARM_DATAPATH_DMEM_WDATA_LOWER_REG
                ARM_DATAPATH_IMEM_RDATA_REG
                ARM_DATAPATH_DMEM_RDATA_INFERENCE_BITS_REG
                ARM_DATAPATH_DMEM_RDATA_UPPER_REG
                ARM_DATAPATH_DMEM_RDATA_LOWER_REG
...
sub DEVICE_PROJ_DIR ()  { "final_v6"; }
sub DEVICE_PROJ_NAME () { "ARM CPU"; }
sub DEVICE_PROJ_DESC () { "ARM CPU"; }
...
sub ILA_TOP_BASE_ADDR ()        { 0x2001100; }
sub ARM_DATAPATH_BASE_ADDR ()   { 0x2001200; }
...
# File: projects/final_v6/include/ila_top.xml
sub ILA_TOP_ILA_UPPER_0_REG ()    { 0x2001100;}
sub ILA_TOP_ILA_LOWER_0_REG ()    { 0x2001104;}
sub ILA_TOP_ILA_UPPER_1_REG ()    { 0x2001108;}
sub ILA_TOP_ILA_LOWER_1_REG ()    { 0x200110c;}
sub ILA_TOP_ILA_UPPER_2_REG ()    { 0x2001110;}
sub ILA_TOP_ILA_LOWER_2_REG ()    { 0x2001114;}
sub ILA_TOP_ILA_UPPER_3_REG ()    { 0x2001118;}
sub ILA_TOP_ILA_LOWER_3_REG ()    { 0x200111c;}
sub ILA_TOP_ILA_UPPER_4_REG ()    { 0x2001120;}
sub ILA_TOP_ILA_LOWER_4_REG ()    { 0x2001124;}
sub ILA_TOP_ILA_UPPER_5_REG ()    { 0x2001128;}
sub ILA_TOP_ILA_LOWER_5_REG ()    { 0x200112c;}
sub ILA_TOP_ILA_UPPER_6_REG ()    { 0x2001130;}
sub ILA_TOP_ILA_LOWER_6_REG ()    { 0x2001134;}
sub ILA_TOP_ILA_UPPER_7_REG ()    { 0x2001138;}
sub ILA_TOP_ILA_LOWER_7_REG ()    { 0x200113c;}
sub ILA_TOP_ILA_UPPER_8_REG ()    { 0x2001140;}
sub ILA_TOP_ILA_LOWER_8_REG ()    { 0x2001144;}
sub ILA_TOP_ILA_UPPER_9_REG ()    { 0x2001148;}
sub ILA_TOP_ILA_LOWER_9_REG ()    { 0x200114c;}
sub ILA_TOP_ILA_UPPER_10_REG ()   { 0x2001150;}
sub ILA_TOP_ILA_LOWER_10_REG ()   { 0x2001154;}
sub ILA_TOP_ILA_UPPER_11_REG ()   { 0x2001158;}
sub ILA_TOP_ILA_LOWER_11_REG ()   { 0x200115c;}
sub ILA_TOP_ILA_UPPER_12_REG ()   { 0x2001160;}
sub ILA_TOP_ILA_LOWER_12_REG ()   { 0x2001164;}
sub ILA_TOP_ILA_UPPER_13_REG ()   { 0x2001168;}
sub ILA_TOP_ILA_LOWER_13_REG ()   { 0x200116c;}
sub ILA_TOP_ILA_UPPER_14_REG ()   { 0x2001170;}
sub ILA_TOP_ILA_LOWER_14_REG ()   { 0x2001174;}
sub ILA_TOP_ILA_UPPER_15_REG ()   { 0x2001178;}
sub ILA_TOP_ILA_LOWER_15_REG ()   { 0x200117c;}

# Name: arm_datapath (ARM_DATAPATH)
# Description: Registers for arm_datapath
# File: projects/final_v6/include/arm_datapath.xml
sub ARM_DATAPATH_IMEM_INTERACT_REG ()               { 0x2001200;}
sub ARM_DATAPATH_IMEM_WRITE_REG ()                  { 0x2001204;}
sub ARM_DATAPATH_IMEM_RW_ADDRESS_REG ()             { 0x2001208;}
sub ARM_DATAPATH_IMEM_WDATA_REG ()                  { 0x200120c;}
sub ARM_DATAPATH_DMEM_INTERACT_REG ()               { 0x2001210;}
sub ARM_DATAPATH_DMEM_WRITE_REG ()                  { 0x2001214;}
sub ARM_DATAPATH_DMEM_RW_ADDRESS_REG ()             { 0x2001218;}
sub ARM_DATAPATH_DMEM_WDATA_UPPER_REG ()            { 0x200121c;}
sub ARM_DATAPATH_DMEM_WDATA_LOWER_REG ()            { 0x2001220;}
sub ARM_DATAPATH_IMEM_RDATA_REG ()                  { 0x2001224;}
sub ARM_DATAPATH_DMEM_RDATA_INFERENCE_BITS_REG ()   { 0x2001228;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_REG ()            { 0x200122c;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_REG ()            { 0x2001230;}
