...
// /___/   /\     Timestamp : 01/30/2025 23:01:55
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2 -w "C:/Documents and Settings/student/EE533_LAB3/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   FD8CE_MXILINX_dropfifo XLXI_11 (.C(clk), 
                                   .CE(XLXN_32), 
                                   .CLR(rst), 
                                   .D(waddr[7:0]), 
                                   .Q(XLXN_27[7:0]));
   // synthesis attribute HU_SET of XLXI_11 is "XLXI_11_17"
   ...
   OR2 XLXI_15 (.I0(XLXN_2), 
                .I1(XLXN_1), 
                .O(XLXN_3));
   AND2B1 XLXI_16 (.I0(XLXN_15), 
                   .I1(XLXN_3), 
                   .O(XLXN_32));
   AND3B2 XLXI_17 (.I0(XLXN_6), 
                   .I1(XLXN_7), 
                   .I2(fiforead), 
                   .O(XLXN_10));
   COMP8_MXILINX_dropfifo XLXI_18 (.A(raddr[7:0]), 
                                   .B(XLXN_27[7:0]), 
                                   .EQ(XLXN_6));
   // synthesis attribute HU_SET of XLXI_18 is "XLXI_18_18"
   COMP8_MXILINX_dropfifo XLXI_19 (.A(waddr[7:0]), 
                                   .B(raddr[7:0]), 
                                   .EQ(XLXN_7));
   // synthesis attribute HU_SET of XLXI_19 is "XLXI_19_19"
   reg9B XLXI_29 (.CE(XLXN_38), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(in_fifo0[71:0]));
   VCC XLXI_30 (.P(XLXN_38));
   dualportmemory XLXI_34 (.addra(waddr[7:0]), 
                           .addrb(raddr[7:0]), 
                           .clka(clk), 
                           .clkb(clk), 
                           .dina(in_fifo0[71:0]), 
