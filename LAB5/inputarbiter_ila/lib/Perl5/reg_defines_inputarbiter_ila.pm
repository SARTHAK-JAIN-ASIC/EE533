...
package reg_defines_inputarbiter_ila;
...
sub DEVICE_PROJ_DIR ()  { "inputarbiter_ila"; }
sub DEVICE_PROJ_NAME () { "inputarbiterila"; }
sub DEVICE_PROJ_DESC () { "inputarbiterila"; }
...
sub IDS_BASE_ADDR ()             { 0x2001200; }
sub ILA_TOP_BASE_ADDR ()         { 0x2001280; }
...
sub IDS_PATTERN_HIGH_REG ()   { 0x2001200;}
sub IDS_PATTERN_LOW_REG ()    { 0x2001204;}
sub IDS_IDS_CMD_REG ()        { 0x2001208;}
sub IDS_MATCHES_REG ()        { 0x200120c;}

# Name: ila_top (ILA_TOP)
# Description: Registers for ila_top
# File: projects/inputarbiter_ila/include/ila_top.xml
sub ILA_TOP_ILA_UPPER_0_REG ()   { 0x2001280;}
sub ILA_TOP_ILA_LOWER_0_REG ()   { 0x2001284;}
sub ILA_TOP_ILA_UPPER_1_REG ()   { 0x2001288;}
sub ILA_TOP_ILA_LOWER_1_REG ()   { 0x200128c;}
sub ILA_TOP_ILA_UPPER_2_REG ()   { 0x2001290;}
sub ILA_TOP_ILA_LOWER_2_REG ()   { 0x2001294;}
sub ILA_TOP_ILA_UPPER_3_REG ()   { 0x2001298;}
sub ILA_TOP_ILA_LOWER_3_REG ()   { 0x200129c;}
sub ILA_TOP_ILA_UPPER_4_REG ()   { 0x20012a0;}
sub ILA_TOP_ILA_LOWER_4_REG ()   { 0x20012a4;}
sub ILA_TOP_ILA_UPPER_5_REG ()   { 0x20012a8;}
sub ILA_TOP_ILA_LOWER_5_REG ()   { 0x20012ac;}
sub ILA_TOP_ILA_UPPER_6_REG ()   { 0x20012b0;}
sub ILA_TOP_ILA_LOWER_6_REG ()   { 0x20012b4;}
sub ILA_TOP_ILA_UPPER_7_REG ()   { 0x20012b8;}
sub ILA_TOP_ILA_LOWER_7_REG ()   { 0x20012bc;}
