...
`define PIPELINE_DATAPATH_IMEM_RDATA              7'h4
`define PIPELINE_DATAPATH_HWREG1                  7'h5
`define PIPELINE_DATAPATH_ADDREG_IMEM_INTERACT    7'h6
`define PIPELINE_DATAPATH_ADDREG_IMEM_RW_ADDRESS  7'h7
`define PIPELINE_DATAPATH_ADDREG_IMEM_WDATA       7'h8
`define PIPELINE_DATAPATH_ADDREG_IMEM_WRITE       7'h9
