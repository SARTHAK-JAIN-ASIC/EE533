...
def PIPELINE_DATAPATH_HWREG1_REG ():                 
    return 0x2001214

def PIPELINE_DATAPATH_ADDREG_IMEM_INTERACT_REG ():   
    return 0x2001218

def PIPELINE_DATAPATH_ADDREG_IMEM_RW_ADDRESS_REG (): 
    return 0x200121c

def PIPELINE_DATAPATH_ADDREG_IMEM_WDATA_REG ():      
    return 0x2001220

def PIPELINE_DATAPATH_ADDREG_IMEM_WRITE_REG ():      
    return 0x2001224
...
__main__.nf_regmap.update({
    ...
    0x2001210 : "PIPELINE_DATAPATH_IMEM_RDATA_REG",
    0x2001214 : "PIPELINE_DATAPATH_HWREG1_REG",
    0x2001218 : "PIPELINE_DATAPATH_ADDREG_IMEM_INTERACT_REG",
    0x200121c : "PIPELINE_DATAPATH_ADDREG_IMEM_RW_ADDRESS_REG",
    0x2001220 : "PIPELINE_DATAPATH_ADDREG_IMEM_WDATA_REG",
    0x2001224 : "PIPELINE_DATAPATH_ADDREG_IMEM_WRITE_REG",
