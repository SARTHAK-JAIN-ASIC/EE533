...
`define PIPELINE_DATAPATH_BLOCK_ADDR_WIDTH  16
`define PIPELINE_DATAPATH_REG_ADDR_WIDTH    7
...
`define PIPELINE_DATAPATH_BLOCK_ADDR  16'h0009
...
// Name: pipeline_datapath
// Description: Registers for pipeline_datapath
// File: projects/3cpu_Lab6/include/pipeline_datapath.xml
`define PIPELINE_DATAPATH_IMEM_INTERACT     7'h0
`define PIPELINE_DATAPATH_IMEM_WRITE        7'h1
`define PIPELINE_DATAPATH_IMEM_RW_ADDRESS   7'h2
`define PIPELINE_DATAPATH_IMEM_WDATA        7'h3
`define PIPELINE_DATAPATH_DMEM_INTERACT     7'h4
`define PIPELINE_DATAPATH_DMEM_WRITE        7'h5
`define PIPELINE_DATAPATH_DMEM_RW_ADDRESS   7'h6
`define PIPELINE_DATAPATH_DMEM_WDATA_UPPER  7'h7
`define PIPELINE_DATAPATH_DMEM_WDATA_LOWER  7'h8
`define PIPELINE_DATAPATH_IMEM_RDATA        7'h9
`define PIPELINE_DATAPATH_DMEM_RDATA_UPPER  7'ha
`define PIPELINE_DATAPATH_DMEM_RDATA_LOWER  7'hb
