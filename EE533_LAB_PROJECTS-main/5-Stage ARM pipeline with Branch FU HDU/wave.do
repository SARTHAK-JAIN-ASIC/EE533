...
add wave -divider {BRANCH ADDR CALC} 
add wave -position insertpoint sim:/ARM_datapath_tb/ARMv7/branch_address_calculator/*

add wave -divider {Flush_On_Branch_Mux} 
add wave -position insertpoint sim:/ARM_datapath_tb/ARMv7/EXFlush_WBSignals/*

add wave -divider {EXMEM} 
add wave -position insertpoint sim:/ARM_datapath_tb/ARMv7/EX_MEM/*

add wave -divider {BRANCH SIGNAL EN} 
add wave -position insertpoint sim:/ARM_datapath_tb/ARMv7/branch_taken_untaked/*
