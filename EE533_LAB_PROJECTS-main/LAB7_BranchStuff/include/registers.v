...
`define ARM_DATAPATH_IMEM_RDATA          7'h4
`define ARM_DATAPATH_DMEM_RDATA_UPPER_0  7'h5
`define ARM_DATAPATH_DMEM_RDATA_LOWER_0  7'h6
`define ARM_DATAPATH_DMEM_RDATA_UPPER_1  7'h7
`define ARM_DATAPATH_DMEM_RDATA_LOWER_1  7'h8
`define ARM_DATAPATH_DMEM_RDATA_UPPER_2  7'h9
`define ARM_DATAPATH_DMEM_RDATA_LOWER_2  7'ha
`define ARM_DATAPATH_DMEM_RDATA_UPPER_3  7'hb
`define ARM_DATAPATH_DMEM_RDATA_LOWER_3  7'hc
`define ARM_DATAPATH_DMEM_RDATA_UPPER_4  7'hd
`define ARM_DATAPATH_DMEM_RDATA_LOWER_4  7'he
`define ARM_DATAPATH_DMEM_RDATA_UPPER_5  7'hf
`define ARM_DATAPATH_DMEM_RDATA_LOWER_5  7'h10
`define ARM_DATAPATH_DMEM_RDATA_UPPER_6  7'h11
`define ARM_DATAPATH_DMEM_RDATA_LOWER_6  7'h12
