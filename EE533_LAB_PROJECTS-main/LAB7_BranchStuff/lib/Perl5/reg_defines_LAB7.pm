...
#
# Project: ARM CPU (LAB7)
# Description: ARM CPU
#
#############################################################

package reg_defines_LAB7;
...
@EXPORT = qw(
                ...
                ARM_DATAPATH_DMEM_RDATA_UPPER_0_REG
                ARM_DATAPATH_DMEM_RDATA_LOWER_0_REG
                ARM_DATAPATH_DMEM_RDATA_UPPER_1_REG
                ARM_DATAPATH_DMEM_RDATA_LOWER_1_REG
                ARM_DATAPATH_DMEM_RDATA_UPPER_2_REG
                ARM_DATAPATH_DMEM_RDATA_LOWER_2_REG
                ARM_DATAPATH_DMEM_RDATA_UPPER_3_REG
                ARM_DATAPATH_DMEM_RDATA_LOWER_3_REG
                ARM_DATAPATH_DMEM_RDATA_UPPER_4_REG
                ARM_DATAPATH_DMEM_RDATA_LOWER_4_REG
                ARM_DATAPATH_DMEM_RDATA_UPPER_5_REG
                ARM_DATAPATH_DMEM_RDATA_LOWER_5_REG
                ARM_DATAPATH_DMEM_RDATA_UPPER_6_REG
                ARM_DATAPATH_DMEM_RDATA_LOWER_6_REG
...
# File: projects/LAB7/include/arm_datapath.xml
...
sub ARM_DATAPATH_IMEM_RDATA_REG ()           { 0x2001210;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_0_REG ()   { 0x2001214;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_0_REG ()   { 0x2001218;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_1_REG ()   { 0x200121c;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_1_REG ()   { 0x2001220;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_2_REG ()   { 0x2001224;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_2_REG ()   { 0x2001228;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_3_REG ()   { 0x200122c;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_3_REG ()   { 0x2001230;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_4_REG ()   { 0x2001234;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_4_REG ()   { 0x2001238;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_5_REG ()   { 0x200123c;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_5_REG ()   { 0x2001240;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_6_REG ()   { 0x2001244;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_6_REG ()   { 0x2001248;}
