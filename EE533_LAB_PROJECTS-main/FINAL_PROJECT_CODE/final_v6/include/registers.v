...
// Tag/address widths
`define ARM_DATAPATH_BLOCK_ADDR_WIDTH  16
`define ARM_DATAPATH_REG_ADDR_WIDTH    7
...
`define ILA_TOP_BLOCK_ADDR_WIDTH       18
`define ILA_TOP_REG_ADDR_WIDTH         5
...
`define ILA_TOP_BLOCK_ADDR       18'h00022
`define ARM_DATAPATH_BLOCK_ADDR  16'h0009
...
`define ARM_DATAPATH_IMEM_INTERACT              7'h0
`define ARM_DATAPATH_IMEM_WRITE                 7'h1
`define ARM_DATAPATH_IMEM_RW_ADDRESS            7'h2
`define ARM_DATAPATH_IMEM_WDATA                 7'h3
`define ARM_DATAPATH_DMEM_INTERACT              7'h4
`define ARM_DATAPATH_DMEM_WRITE                 7'h5
`define ARM_DATAPATH_DMEM_RW_ADDRESS            7'h6
`define ARM_DATAPATH_DMEM_WDATA_UPPER           7'h7
`define ARM_DATAPATH_DMEM_WDATA_LOWER           7'h8
`define ARM_DATAPATH_IMEM_RDATA                 7'h9
`define ARM_DATAPATH_DMEM_RDATA_INFERENCE_BITS  7'ha
`define ARM_DATAPATH_DMEM_RDATA_UPPER           7'hb
`define ARM_DATAPATH_DMEM_RDATA_LOWER           7'hc
...
`define ILA_TOP_ILA_UPPER_0   5'h0
`define ILA_TOP_ILA_LOWER_0   5'h1
`define ILA_TOP_ILA_UPPER_1   5'h2
`define ILA_TOP_ILA_LOWER_1   5'h3
`define ILA_TOP_ILA_UPPER_2   5'h4
`define ILA_TOP_ILA_LOWER_2   5'h5
`define ILA_TOP_ILA_UPPER_3   5'h6
`define ILA_TOP_ILA_LOWER_3   5'h7
`define ILA_TOP_ILA_UPPER_4   5'h8
`define ILA_TOP_ILA_LOWER_4   5'h9
`define ILA_TOP_ILA_UPPER_5   5'ha
`define ILA_TOP_ILA_LOWER_5   5'hb
`define ILA_TOP_ILA_UPPER_6   5'hc
`define ILA_TOP_ILA_LOWER_6   5'hd
`define ILA_TOP_ILA_UPPER_7   5'he
`define ILA_TOP_ILA_LOWER_7   5'hf
`define ILA_TOP_ILA_UPPER_8   5'h10
`define ILA_TOP_ILA_LOWER_8   5'h11
`define ILA_TOP_ILA_UPPER_9   5'h12
`define ILA_TOP_ILA_LOWER_9   5'h13
`define ILA_TOP_ILA_UPPER_10  5'h14
`define ILA_TOP_ILA_LOWER_10  5'h15
`define ILA_TOP_ILA_UPPER_11  5'h16
`define ILA_TOP_ILA_LOWER_11  5'h17
`define ILA_TOP_ILA_UPPER_12  5'h18
`define ILA_TOP_ILA_LOWER_12  5'h19
`define ILA_TOP_ILA_UPPER_13  5'h1a
`define ILA_TOP_ILA_LOWER_13  5'h1b
`define ILA_TOP_ILA_UPPER_14  5'h1c
`define ILA_TOP_ILA_LOWER_14  5'h1d
`define ILA_TOP_ILA_UPPER_15  5'h1e
`define ILA_TOP_ILA_LOWER_15  5'h1f
