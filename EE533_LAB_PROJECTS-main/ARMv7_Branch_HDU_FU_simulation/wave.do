...
add wave -divider {BranchAddressCalculation} 
add wave -position insertpoint sim:/ARM_datapath_tb/ARMv7/branch_address/*
...
add wave -divider {master_branch_o}
add wave -position insertpoint sim:/ARM_datapath_tb/ARMv7/master_branch_o
