...
def PIPELINE_DATAPATH_BASE_ADDR (): 
    return 0x2001200
...
def PIPELINE_DATAPATH_IMEM_INTERACT_REG ():    
    return 0x2001200

def PIPELINE_DATAPATH_IMEM_WRITE_REG ():       
    return 0x2001204

def PIPELINE_DATAPATH_IMEM_RW_ADDRESS_REG ():  
    return 0x2001208

def PIPELINE_DATAPATH_IMEM_WDATA_REG ():       
    return 0x200120c

def PIPELINE_DATAPATH_DMEM_INTERACT_REG ():    
    return 0x2001210

def PIPELINE_DATAPATH_DMEM_WRITE_REG ():       
    return 0x2001214

def PIPELINE_DATAPATH_DMEM_RW_ADDRESS_REG ():  
    return 0x2001218

def PIPELINE_DATAPATH_DMEM_WDATA_UPPER_REG (): 
    return 0x200121c

def PIPELINE_DATAPATH_DMEM_WDATA_LOWER_REG (): 
    return 0x2001220

def PIPELINE_DATAPATH_IMEM_RDATA_REG ():       
    return 0x2001224

def PIPELINE_DATAPATH_DMEM_RDATA_UPPER_REG (): 
    return 0x2001228

def PIPELINE_DATAPATH_DMEM_RDATA_LOWER_REG (): 
    return 0x200122c
...
__main__.nf_regmap.update({
    ...
    0x2001200 : "PIPELINE_DATAPATH_IMEM_INTERACT_REG",
    0x2001204 : "PIPELINE_DATAPATH_IMEM_WRITE_REG",
    0x2001208 : "PIPELINE_DATAPATH_IMEM_RW_ADDRESS_REG",
    0x200120c : "PIPELINE_DATAPATH_IMEM_WDATA_REG",
    0x2001210 : "PIPELINE_DATAPATH_DMEM_INTERACT_REG",
    0x2001214 : "PIPELINE_DATAPATH_DMEM_WRITE_REG",
    0x2001218 : "PIPELINE_DATAPATH_DMEM_RW_ADDRESS_REG",
    0x200121c : "PIPELINE_DATAPATH_DMEM_WDATA_UPPER_REG",
    0x2001220 : "PIPELINE_DATAPATH_DMEM_WDATA_LOWER_REG",
    0x2001224 : "PIPELINE_DATAPATH_IMEM_RDATA_REG",
    0x2001228 : "PIPELINE_DATAPATH_DMEM_RDATA_UPPER_REG",
    0x200122c : "PIPELINE_DATAPATH_DMEM_RDATA_LOWER_REG",
