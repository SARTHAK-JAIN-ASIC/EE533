...
#
# Project: ARM CPU (Lab7_netfpga)
# Description: ARM CPU
#
#############################################################

package reg_defines_Lab7_netfpga;
...
sub DEVICE_PROJ_DIR ()  { "Lab7_netfpga"; }
...
sub ARM_DATAPATH_BASE_ADDR ()   { 0x2001000; }
sub IN_ARB_BASE_ADDR ()         { 0x2001200; }
...
# File: projects/Lab7_netfpga/include/arm_datapath.xml
sub ARM_DATAPATH_IMEM_INTERACT_REG ()      { 0x2001000;}
sub ARM_DATAPATH_IMEM_WRITE_REG ()         { 0x2001004;}
sub ARM_DATAPATH_IMEM_RW_ADDRESS_REG ()    { 0x2001008;}
sub ARM_DATAPATH_IMEM_WDATA_REG ()         { 0x200100c;}
sub ARM_DATAPATH_DMEM_INTERACT_REG ()      { 0x2001010;}
sub ARM_DATAPATH_DMEM_WRITE_REG ()         { 0x2001014;}
sub ARM_DATAPATH_DMEM_RW_ADDRESS_REG ()    { 0x2001018;}
sub ARM_DATAPATH_DMEM_WDATA_UPPER_REG ()   { 0x200101c;}
sub ARM_DATAPATH_DMEM_WDATA_LOWER_REG ()   { 0x2001020;}
sub ARM_DATAPATH_IMEM_RDATA_REG ()         { 0x2001024;}
sub ARM_DATAPATH_DMEM_RDATA_UPPER_REG ()   { 0x2001028;}
sub ARM_DATAPATH_DMEM_RDATA_LOWER_REG ()   { 0x200102c;}

# Name: in_arb (IN_ARB)
# Description: Round-robin input arbiter
# File: lib/verilog/core/input_arbiter/rr_input_arbiter/xml/rr_input_arbiter.xml
sub IN_ARB_NUM_PKTS_SENT_REG ()        { 0x2001200;}
sub IN_ARB_LAST_PKT_WORD_0_HI_REG ()   { 0x2001204;}
sub IN_ARB_LAST_PKT_WORD_0_LO_REG ()   { 0x2001208;}
sub IN_ARB_LAST_PKT_CTRL_0_REG ()      { 0x200120c;}
sub IN_ARB_LAST_PKT_WORD_1_HI_REG ()   { 0x2001210;}
sub IN_ARB_LAST_PKT_WORD_1_LO_REG ()   { 0x2001214;}
sub IN_ARB_LAST_PKT_CTRL_1_REG ()      { 0x2001218;}
sub IN_ARB_STATE_REG ()                { 0x200121c;}
