...
#
# Project: Reference NIC (Lab5_v3)
# Description: Reference NIC
#
#############################################################

package reg_defines_Lab5_v3;
...
sub IDS_BASE_ADDR ()           { 0x2001100; }
sub ILA_TOP_BASE_ADDR ()       { 0x2001180; }
...
# File: projects/Lab5_v3/include/ids.xml
sub IDS_PATTERN_HIGH_REG ()   { 0x2001100;}
sub IDS_PATTERN_LOW_REG ()    { 0x2001104;}
sub IDS_IDS_CMD_REG ()        { 0x2001108;}
sub IDS_MATCHES_REG ()        { 0x200110c;}

# Name: ila_top (ILA_TOP)
# Description: Registers for ila_top
# File: projects/Lab5_v3/include/ila_top.xml
sub ILA_TOP_ILA_UPPER_0_REG ()   { 0x2001180;}
sub ILA_TOP_ILA_LOWER_0_REG ()   { 0x2001184;}
sub ILA_TOP_ILA_UPPER_1_REG ()   { 0x2001188;}
sub ILA_TOP_ILA_LOWER_1_REG ()   { 0x200118c;}
sub ILA_TOP_ILA_UPPER_2_REG ()   { 0x2001190;}
sub ILA_TOP_ILA_LOWER_2_REG ()   { 0x2001194;}
sub ILA_TOP_ILA_UPPER_3_REG ()   { 0x2001198;}
sub ILA_TOP_ILA_LOWER_3_REG ()   { 0x200119c;}
sub ILA_TOP_ILA_UPPER_4_REG ()   { 0x20011a0;}
sub ILA_TOP_ILA_LOWER_4_REG ()   { 0x20011a4;}
sub ILA_TOP_ILA_UPPER_5_REG ()   { 0x20011a8;}
sub ILA_TOP_ILA_LOWER_5_REG ()   { 0x20011ac;}
sub ILA_TOP_ILA_UPPER_6_REG ()   { 0x20011b0;}
sub ILA_TOP_ILA_LOWER_6_REG ()   { 0x20011b4;}
sub ILA_TOP_ILA_UPPER_7_REG ()   { 0x20011b8;}
sub ILA_TOP_ILA_LOWER_7_REG ()   { 0x20011bc;}
