...
#
# Project: ARM CPU (bfloat10_v1)
# Description: ARM CPU
#
#############################################################

package reg_defines_bfloat10_v1;
...
@EXPORT = qw(
                ...
                NPU_PIPELINE_TOP_SW_REG_INFERENCE_MEM_ADDR_REG
                NPU_PIPELINE_TOP_HW_REG_INFERENCE_MEM_DATA_REG
...
sub DEVICE_PROJ_DIR ()  { "bfloat10_v1"; }
...
sub NPU_PIPELINE_TOP_BASE_ADDR ()   { 0x2001200; }
...
# File: projects/bfloat10_v1/include/ila_top.xml
...
# Name: NPU_pipeline_top (NPU_PIPELINE_TOP)
# Description: Registers for NPU_pipeline_top
# File: projects/bfloat10_v1/include/NPU_pipeline_top.xml
sub NPU_PIPELINE_TOP_SW_REG_INFERENCE_MEM_ADDR_REG ()   { 0x2001200;}
sub NPU_PIPELINE_TOP_HW_REG_INFERENCE_MEM_DATA_REG ()   { 0x2001204;}
