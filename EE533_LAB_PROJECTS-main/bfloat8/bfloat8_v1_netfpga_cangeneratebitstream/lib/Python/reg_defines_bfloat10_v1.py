...
def NPU_PIPELINE_TOP_BASE_ADDR (): 
    return 0x2001200
...
def NPU_PIPELINE_TOP_SW_REG_INFERENCE_MEM_ADDR_REG (): 
    return 0x2001200

def NPU_PIPELINE_TOP_HW_REG_INFERENCE_MEM_DATA_REG (): 
    return 0x2001204
...
__main__.nf_regmap.update({
    ...
    0x2001200 : "NPU_PIPELINE_TOP_SW_REG_INFERENCE_MEM_ADDR_REG",
    0x2001204 : "NPU_PIPELINE_TOP_HW_REG_INFERENCE_MEM_DATA_REG",
