...
#
# Project: Reference NIC (3cpu_Lab6)
# Description: Reference NIC
#
#############################################################

package reg_defines_3cpu_Lab6;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                PIPELINE_DATAPATH_IMEM_INTERACT_REG
                PIPELINE_DATAPATH_IMEM_WRITE_REG
                PIPELINE_DATAPATH_IMEM_RW_ADDRESS_REG
                PIPELINE_DATAPATH_IMEM_WDATA_REG
                PIPELINE_DATAPATH_DMEM_INTERACT_REG
                PIPELINE_DATAPATH_DMEM_WRITE_REG
                PIPELINE_DATAPATH_DMEM_RW_ADDRESS_REG
                PIPELINE_DATAPATH_DMEM_WDATA_UPPER_REG
                PIPELINE_DATAPATH_DMEM_WDATA_LOWER_REG
                PIPELINE_DATAPATH_IMEM_RDATA_REG
                PIPELINE_DATAPATH_DMEM_RDATA_UPPER_REG
                PIPELINE_DATAPATH_DMEM_RDATA_LOWER_REG
...
sub PIPELINE_DATAPATH_BASE_ADDR ()   { 0x2001200; }
...
# Name: pipeline_datapath (PIPELINE_DATAPATH)
# Description: Registers for pipeline_datapath
# File: projects/3cpu_Lab6/include/pipeline_datapath.xml
sub PIPELINE_DATAPATH_IMEM_INTERACT_REG ()      { 0x2001200;}
sub PIPELINE_DATAPATH_IMEM_WRITE_REG ()         { 0x2001204;}
sub PIPELINE_DATAPATH_IMEM_RW_ADDRESS_REG ()    { 0x2001208;}
sub PIPELINE_DATAPATH_IMEM_WDATA_REG ()         { 0x200120c;}
sub PIPELINE_DATAPATH_DMEM_INTERACT_REG ()      { 0x2001210;}
sub PIPELINE_DATAPATH_DMEM_WRITE_REG ()         { 0x2001214;}
sub PIPELINE_DATAPATH_DMEM_RW_ADDRESS_REG ()    { 0x2001218;}
sub PIPELINE_DATAPATH_DMEM_WDATA_UPPER_REG ()   { 0x200121c;}
sub PIPELINE_DATAPATH_DMEM_WDATA_LOWER_REG ()   { 0x2001220;}
sub PIPELINE_DATAPATH_IMEM_RDATA_REG ()         { 0x2001224;}
sub PIPELINE_DATAPATH_DMEM_RDATA_UPPER_REG ()   { 0x2001228;}
sub PIPELINE_DATAPATH_DMEM_RDATA_LOWER_REG ()   { 0x200122c;}
